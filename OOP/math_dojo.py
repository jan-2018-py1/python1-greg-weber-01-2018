...
md_easy = MathDojo()
print md_easy.add(2).add(2,5).subtract(3,2).total  #result: 4

md_with_lists = MathDojo()
print md_with_lists.add([1], 3,4).add([3,5,7,8], [2,4.3,1.25]).subtract(2, [2,3], [1.1,2.3]).total  #result: 28.15

md_with_tuples = MathDojo()
print md_with_tuples.add(2,(2,2), [2,2,2]).subtract(2,(2,2),[2,2]).total  #result: 2
